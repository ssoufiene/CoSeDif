...
class Transformer(Module):
    ...
    def forward(self, x):
        for attn, ff in self.layers:
            ...
            x = ff(x)
        return x
# experimented with using an fft based conditionner class however didnt get satisfying results so ended up remooving it in the unet forward pass below 
...
# vision transformer for the conditionner 
...
#--------------Main Model Loop----------------------------
# 1-step : Add Noise using q-sample
# 2-step
